...
# nohup command:
#       nohup /home/haoliang.xue_ext/miniconda3/envs/kamrat-valid/bin/snakemake --snakefile kamrat-on-varmat.smk --cluster "qsub -q lowprio -l nodes=node40:ppn=1 -l mem=450G -l walltime=300:00:00 -m ea -M xhl-1993@hotmail.com" --jobs 6 -p --latency-wait 60 --rerun-incomplete >> workflow_kamrat-on-varmat3.txt &
