...
#PBS -q ssfa
#PBS -W depend=afterok:806858

dir_prefix="/data/work/I2BC/haoliang.xue/PRAD_TCGA"

test_set_prefix=$dir_prefix"/b_splitCV"
sig_contig_prefix=$dir_prefix"/d_signatures/d2_rank-first/model.train"
out_dir=$dir_prefix"/d_signatures/d2_rank-first/count-in-tests"
