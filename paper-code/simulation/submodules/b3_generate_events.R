...
# gvf.path <- "/home/haoliang.xue/media/data/kamrat/paper/simulation/b_reference_gen/b_1000GENOMES-phase_3.sel.gvf"
# out.path <- "/home/haoliang.xue/media/data/kamrat/paper/simulation/b_reference_gen/c_variation_events.fa"
