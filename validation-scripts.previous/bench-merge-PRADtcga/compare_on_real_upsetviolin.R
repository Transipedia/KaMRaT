...
ctg.dir <- "../../../revision/PRADtcga-norank/"
...
# pdf(paste0(ctg.dir, "contigs-on-PRADtcga.upset.pdf"), width = 16, height = 9)
# upset(fromList(list("none" = align[["none"]]$seq,
#                     "pearson" = align[["pearson"]]$seq,
#                     "spearman" = align[["spearman"]]$seq,
#                     "mac" = align[["mac"]]$seq)),
#       order.by = "freq", nintersects = NA, show.numbers = "yes",
#       sets.bar.color = "gold3", main.bar.color = "royalblue",
#       text.scale = 3) 
# dev.off()
