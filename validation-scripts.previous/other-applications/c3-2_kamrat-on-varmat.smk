...
# nohup command:
#       nohup /home/haoliang.xue_ext/miniconda3/envs/kamrat-valid/bin/snakemake --snakefile c3-2_kamrat-on-varmat.smk --cluster "qsub -q lowprio -l nodes=1:ppn=1 -l mem=350G -l walltime=300:00:00 -m ea -M xue.haoliang@outlook.com" --jobs 6 -p --latency-wait 60 --rerun-incomplete >> workflow_c3_kamrat-on-varmat.txt &
