...
../bin/kamrat rank -idxdir output/kamrat.idx -rankby ttest.padj -design data/sample-condition.toy.tsv -with output/mergingfirst/merged-kmers.bin -seltop 0.1 -outpath output/mergingfirst/top-ctg-counts.tsv -withcounts
